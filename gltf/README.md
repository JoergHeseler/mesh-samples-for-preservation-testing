All glTF files were validated with the [glTF validation tool](https://git.slub-dresden.de/nfdi4culturedigitalpreservation/gltf-validator-for-archivematica). glTF files ending in `-valid` pass validation, while all other files fail.
